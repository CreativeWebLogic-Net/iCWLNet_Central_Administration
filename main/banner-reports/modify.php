      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><form action="modify.php"  method="post" name="form2" >
              <span class="pageheading">View Member Reports </span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
              <br>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
                <tr bgcolor="#363E57" id="tablecell">
                  <td width="12%" class="tabletitle"> Member ID</td>
                  <td class="tabletitle">Member Name</td>
                  <td width="9%" align="center" class="tabletitle">View</td>
                </tr>
                <?php
					  	$Count=0;
					 	$r=new ReturnRecord();
						$sq2=$r->rawQuery("SELECT id,name,TheBill FROM users ORDER BY id");  
						while ($myrow = $r->Fetch_Array($sq2)) {
						?>
                <tr class="<?php print(($Count%2)==0 ? "row1" : "row2"); ?>">
                  <td><?php print $myrow[0];?></td>
                  <td><?php print $myrow[1];?></td>
                  <td><a href="details.php?id=<?php print $myrow[0];?>"><img src="../../images/select.gif" width="47" height="16" border="0"></a></td>
                </tr>
                <?php
							$Count++;
						};
