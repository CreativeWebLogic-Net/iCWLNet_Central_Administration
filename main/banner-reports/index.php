<?php
	...
	if($_POST['Submit']){
		...
		$m->AddFunctions(array("DatePaid"=>"NOW()"));
		$m->AddTable("Payments");
		$m->DoStuff();
		$NewID=$m->ReturnID();
  ...
  <tr>
    ...
    <td valign="top" class="rightbg">
      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top"><form action="index.php"  method="post" name="form2" onSubmit="YY_checkform('form2','FirstName','#q','0','You must fill in the field Name.','Email','S','2','You must fill in a valid Email Address.','UserName','#q','0','You must fill in the field Username.','Password','#q','0','You must fill in the field Password','Password2','#Password','6','Passwords must match.');return document.MM_returnValue" >
              <span class="pageheading">Make Payment </span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
            Complete the payment details below.<br>
            <br>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
              <tr>
                ...
                <td class="tablewhite"><select name="usersID" id="usersID">
                  <?php
	  	$rslt=$r->RawQuery("SELECT id,Name FROM users");
	  ...
	  ?>
              ...
              <tr>
                <td width="163" class="tabletitle"><strong> Amount Paid<span class="RedText">*</span></strong></td>
                <td width="352" class="tablewhite">$
                  <input name="Amount" type="text" id="Amount" size="45" /></td>
              </tr>
