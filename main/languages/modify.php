<?php
	...
	if(isset($_POST['Delete'])){
        ...
        $m->Set_Database($r);
				...
				$Message="No Languages Selected To Delete";
			};
		};
	}
      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><form action="modify.php"  method="post" name="form2" >
              <span class="pageheading">Modify / Delete Languages </span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
                <tr bgcolor="#363E57" id="tablecell">
                  <td class="tabletitle"> Language Name</td>
                ...
                <?php
					  	$Count=0;
					 	//$r=new ReturnRecord();
						$sq2=$r->rawQuery("SELECT id,Name FROM languages ORDER BY Name");  
            ...
            <strong><br>
              To Delete a Language:</strong> select the checkbox for that Language and then choose Delete button. <br>
            <strong>Tip:</strong> You can select multiple Languages. <br>
          </form></td>
        </tr>
      </table></td>
  </tr>
