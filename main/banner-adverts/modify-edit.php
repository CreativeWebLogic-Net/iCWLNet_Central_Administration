  ...
  <tr>
    ...
    <td valign="top" class="rightbg">
      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top"><form action="modify-edit.php"  method="post" enctype="multipart/form-data" name="form2" >
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><span class="pageheading">Modify Banner </span><span class="RedText"><?php print $Message; ?></span></td>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
              ...
              <tr>
                <td class="tabletitle"><strong>Banner Target</strong></td>
                <td class="tablewhite"><input name="Href" type="text" id="Href" value="<?php print $Insert['Href']; ?>" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Banner Upload<span class="RedText"></span></strong></td>
                <td class="tablewhite"><input type="file" name="Banner" id="Banner" />
                  <br />
                  <?php print $Insert['Banner']; ?></td>
              </tr>
              <tr>
                <td colspan="2" class="tabletitle"><strong>Banner Text</strong></td>
              </tr>
              <tr>
                <td colspan="2" class="tablewhite"><textarea name="Description" cols="60" rows="20" id="Description"><?php print $Insert['Description']; ?>
            </textarea></td>
              </tr>
              <tr>
