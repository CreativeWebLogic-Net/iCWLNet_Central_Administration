<?php
	...
	if($_POST['Submit']){
		...
		$m->AddSkip(array("id"));
		$m->AddTable("mod_business_categories");
		$m->AddID($_POST['id']);
		$m->DoStuff();
	...
	$r->AddTable("mod_business_categories");
	$r->AddSearchVar($id);
	$Insert=$r->GetRecord();
        ...
        <tr>
          <td valign="top"><form action="modify-edit.php"  method="post" name="form2" onSubmit="YY_checkform('form2','FirstName','#q','0','You must fill in the field Name.','Email','S','2','You must fill in a valid Email Address.','UserName','#q','0','You must fill in the field Username.','Password','#q','0','You must fill in the field Password','Password2','#Password','6','Passwords must match.');return document.MM_returnValue">
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><span class="pageheading">Modify Business Category</span><span class="RedText"><?php print $Message; ?></span></td>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
              <tr>
                <td><strong>Category Title<span class="RedText">*</span></strong></td>
                <td><input name="CategoryTitle" type="text" id="CategoryTitle" value="<?php print $Insert['CategoryTitle'];?>" size="45"></td>
              </tr>
              <tr>
                <td><strong> Sub-Domain Address<span class="RedText">*</span></strong></td>
                <td><input name="SubDomain" type="text" id="SubDomain" value="<?php print $Insert['SubDomain'];?>" size="45"></td>
              </tr>
              </table>
