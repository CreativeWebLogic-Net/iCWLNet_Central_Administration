      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><form action="modify.php"  method="post" name="form2" >
              <span class="pageheading">Modify / Delete Business Categories</span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
                <tr bgcolor="#363E57" id="tablecell">
                  <td width="37%" class="tabletitle"> Category Title</td>
                  <td width="46%" class="tabletitle">Sub Domain</td>
                ...
                <?php
					  	$Count=0;
					 	$r=new ReturnRecord();
						$sq2=$r->rawQuery("SELECT id,CategoryTitle,SubDomain FROM mod_business_categories WHERE domainsID=$_SESSION[domainsID] ORDER BY CategoryTitle");  
