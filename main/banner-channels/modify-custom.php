<?php
	...
	if($_POST['Delete']=="Delete"){
		if(is_array($_POST['DFiles'])){
			...
			$Message="No Channels Selected To Delete";
		};
	};
  ...
  <tr>
    ...
    <td valign="top" class="rightbg">
      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><form action="modify-custom.php"  method="post" name="form2" >
              <span class="pageheading">Modify / Delete Custom Channel Prices </span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
              <br>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
                <tr bgcolor="#363E57" id="tablecell">
                  <td width="23%" class="tabletitle"> Channel ID</td>
                  <td width="30%" class="tabletitle">Member Name</td>
                  <td width="30%" class="tabletitle">PPC Amount</td>
                ...
                <?php
					  	$Count=0;
					 	$r=new ReturnRecord();
						$sq2=$r->rawQuery("SELECT ChannelsCustom.id,name,PPC,ChannelsID FROM ChannelsCustom,users WHERE ChannelsCustom.usersID=users.id");  
                ...
                <tr class="<?php print(($Count%2)==0 ? "row1" : "row2"); ?>">
                  ...
                  <td align="center"><a href="modify-edit-custom.php?id=<?php print $myrow[0];?>"><img src="../../images/modify.gif" width="47" height="16" border="0"></a></td>
                  <td><div align="center">
            ...
            <strong><br>
              To Delete an Custom Price:</strong> select the checkbox for that Custom Price and then choose Delete button. <br>
            <strong>Tip:</strong> You can select multiple Custom Prices. <br>
          </form></td>
        </tr>
      </table></td>
  </tr>
