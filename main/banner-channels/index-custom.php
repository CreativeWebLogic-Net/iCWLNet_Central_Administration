        ...
        <tr>
          <td valign="top"><form action="index-custom.php"  method="post" name="form2" onSubmit="YY_checkform('form2','FirstName','#q','0','You must fill in the field Name.','Email','S','2','You must fill in a valid Email Address.','UserName','#q','0','You must fill in the field Username.','Password','#q','0','You must fill in the field Password','Password2','#Password','6','Passwords must match.');return document.MM_returnValue" >
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
              <tr>
                <td class="tabletitle"><strong>Channel</strong></td>
                <td class="tablewhite" id="tablecell"><select name="ChannelsID" id="ChannelsID">
                  <?php
					  	$r=new ReturnRecord();
              ...
              <tr>
                <td width="163" class="tabletitle"><strong>Member<span class="RedText">*</span></strong></td>
                <td width="352" class="tablewhite" id="tablecell"><select name="usersID" id="usersID">
                  <?php
					  	$r=new ReturnRecord();
              ...
              <tr>
                ...
                <td class="tablewhite" id="tablecell">$
                  <input name="Fee" type="text" id="Fee" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Interval</strong></td>
                <td class="tablewhite" id="tablecell"><select name="PInterval" id="PInterval">
