        ...
        <tr>
          <td valign="top"><form action="modify-edit.php"  method="post" name="form2" onSubmit="YY_checkform('form2','FirstName','#q','0','You must fill in the field Name.','Email','S','2','You must fill in a valid Email Address.','UserName','#q','0','You must fill in the field Username.','Password','#q','0','You must fill in the field Password','Password2','#Password','6','Passwords must match.');return document.MM_returnValue">
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><span class="pageheading">Modify Channel </span><span class="RedText"><?php print $Message; ?></span></td>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
              <tr>
                ...
                <td class="tablewhite"><input name="id2" type="text" class="formfield1" id="id2" value="<?php print $Insert['id']; ?>" /></td>
              </tr>
              <tr>
                <td width="163" class="tabletitle"><strong> Name<span class="RedText">*</span></strong></td>
                <td width="352" class="tablewhite"><input name="Name" type="text" class="formfield1" id="Name" value="<?php print $Insert['Name']; ?>" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Banner Width</strong></td>
                <td class="tablewhite"><input name="Width" type="text" id="Width" value="<?php print $Insert['Width']; ?>" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Banner Height</strong></td>
                <td class="tablewhite"><input name="Height" type="text" id="Height" value="<?php print $Insert['Height']; ?>" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Refresh Seconds (0 never)</strong></td>
                <td class="tablewhite"><input name="RefreshSeconds" type="text" id="RefreshSeconds" value="<?php print $Insert['RefreshSeconds']; ?>" size="45" /></td>
              </tr>
              <tr>
