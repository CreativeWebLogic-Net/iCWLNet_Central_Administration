...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0" class="border">
  <tr>
    <td width="179" valign="top" class="ManagementContentLeftColumn"><table width="97%"  border="0" align="center" cellpadding="0" cellspacing="0" class="ManagementContentLeftColumnLinks">
      ...
      <tr>
        <td valign="top"><?php include("../includes/submenu-banners.php");?></td>
      </tr>
    </table></td>
      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top"><form action="index.php"  method="post" name="form2" onSubmit="YY_checkform('form2','FirstName','#q','0','You must fill in the field Name.','Email','S','2','You must fill in a valid Email Address.','UserName','#q','0','You must fill in the field Username.','Password','#q','0','You must fill in the field Password','Password2','#Password','6','Passwords must match.');return document.MM_returnValue" >
              <span class="pageheading">Add New Channel </span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
            Complete the channel details below.<br>
            <br>
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
              <tr>
                <td class="tabletitle"><strong>Channel ID</strong></td>
                <td class="tablewhite"><input name="id" type="text" id="id" size="45" /></td>
              </tr>
              <tr>
                <td width="163" class="tabletitle"><strong> Name<span class="RedText">*</span></strong></td>
                <td width="352" class="tablewhite"><input name="Name" type="text" id="Name" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Banner Width</strong></td>
                <td class="tablewhite"><input name="Width" type="text" id="Width" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Banner Height</strong></td>
                <td class="tablewhite"><input name="Height" type="text" id="Height" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Refresh Seconds (0 never)</strong></td>
                <td class="tablewhite"><input name="RefreshSeconds" type="text" id="RefreshSeconds" value="0" size="45" /></td>
              </tr>
              <tr>
                <td class="tabletitle"><strong>Time Fee</strong></td>
                <td class="tablewhite">$
                  <input name="Fee" type="text" id="Fee" size="45" /></td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="tabletitle"><strong>PayPerClick Amount<span class="RedText"></span></strong></td>
                <td class="tablewhite">$
                  <input name="PPC" type="text" id="PPC" size="45" /></td>
              </tr>
