      ...
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><form action="modify.php"  method="post" name="form2" >
              <span class="pageheading">Modify / Delete Channels </span><span class="RedText"><?php print $Message; ?></span><br>
              <br>
              <br>
              <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
                <tr bgcolor="#363E57" id="tablecell">
                  <td width="12%" class="tabletitle"> Channel ID</td>
                  <td width="45%" class="tabletitle">Channel Name</td>
                  <td width="12%" class="tabletitle">PPC Amount</td>
                  <td width="14%" class="tabletitle">Banner Count</td>
                ...
                <?php
					  	$Count=0;
					 	$r=new ReturnRecord();
						$sq2=$r->rawQuery("SELECT id,Name,PPC FROM Channels");  
                ...
                <tr class="<?php print(($Count%2)==0 ? "row1" : "row2"); ?>">
                  ...
                  <td><?php
					  	$rslt=$r->rawQuery("SELECT COUNT(id) FROM Adverts WHERE ChannelsID=$myrow[0]");  
            ...
            <strong><br>
              To Delete an Channel:</strong> select the checkbox for that Channel and then choose Delete button. <br>
            <strong>Tip:</strong> You can select multiple Channels. <br>
          </form></td>
        </tr>
      </table></td>
  </tr>
