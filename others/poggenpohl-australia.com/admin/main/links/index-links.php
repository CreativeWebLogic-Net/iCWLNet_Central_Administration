...
<table width="829" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="content">
      ...
      <tr>
        <td height="59"></td>
        <td valign="top"><span class="contentHeading">Add New Link </span><span class="RedText"><?php print $Message; ?></span><br />
  ...
  <table width="99%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
    ...
    <tr>
      <td width="138"><strong>Sort Order </strong></td>
      <td width="434"><input name="SOrder" type="text" id="Name4" size="4" /></td>
    </tr>
    <tr>
