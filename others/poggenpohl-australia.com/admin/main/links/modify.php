...
<table width="829" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="content">
      ...
      <tr>
        <td height="59"></td>
        <td valign="top"><span class="contentHeading">Modify / Delete Link Categories </span><span class="RedText"><?php print $Message; ?></span><br />
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="24" valign="top" class="box"><form action="modify.php"  method="post" name="form2" id="form2" >
              <br />
              <table width="100%" border="0" cellpadding="3" cellspacing="1" id="table">
                  ...
                  <?
					...
					?>
                  <tr align="right" >
                    <td colspan="2" class="tableHeaders">&nbsp;</td>
