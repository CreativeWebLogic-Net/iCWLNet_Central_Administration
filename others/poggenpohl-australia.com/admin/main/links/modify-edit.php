...
<table width="829" border="0" cellpadding="0" cellspacing="0">
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="content">
      ...
      <tr>
        ...
        <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><span class="pageheading"><span class="contentHeading">Modify Link Category </span><span class="RedText"><?php print $Message; ?></span></span></td>
  ...
  <table width="99%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
    <tr>
      <td width="162"><strong> Name<span class="RedText">*</span></strong></td>
      <td width="411"><input name="Name" type="text" class="formfield1" id="Name" value="<?php print $Insert['Name']; ?>" /></td>
    </tr>
    <tr>
