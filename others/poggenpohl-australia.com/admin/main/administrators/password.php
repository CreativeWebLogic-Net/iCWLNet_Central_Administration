...
<table width="829" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="content">
      ...
      <tr>
        <td height="59"></td>
        <td valign="top"><span class="contentHeading">Change Your Password </span><span class="RedText"><?php print $Message; ?></span><br />
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="24" valign="top" class="box"><form action="password.php"  method="post" name="form2" id="form2" >
                <table width="100%" border="0" cellpadding="3" cellspacing="1" id="tablecell">
                  ...
                  <tr>
                    ...
                    <td><input name="Password" type="password" class="formfield1" id="Password" /></td>
                  </tr>
                  <tr>
                    <td><strong>Retype New Password</strong></td>
                    <td><input name="Password2" type="password" class="formfield1" id="Password2" /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
